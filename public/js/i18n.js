...
const TRANSLATIONS = {
  es: {
    ...
    // Superadmin
    sa_title: 'Panel de Administración GAN',
    sa_subtitle: 'Gestión de postulaciones, instituciones y miembros.',
    sa_stat_total: 'Total postulaciones',
    sa_stat_approved: 'Aprobadas',
    sa_stat_rejected: 'Rechazadas',
    sa_stat_review: 'En revisión',
    sa_stat_institutions: 'Instituciones activas',
    sa_tab_applications: 'Postulaciones',
    sa_tab_institutions: 'Instituciones',
    sa_tab_members: 'Miembros',
    sa_tab_benefits: 'Beneficios',
    sa_filter_all: 'Todas',
    sa_filter_pending: 'Pendientes',
    sa_filter_review: 'En revisión',
    sa_filter_approved: 'Aprobadas',
    sa_filter_rejected: 'Rechazadas',
    sa_search_placeholder: 'Buscar institución o email...',
    sa_select_app: 'Selecciona una postulación',
    sa_select_app_hint: 'Haz clic en cualquier postulación de la lista para ver el detalle y la evaluación de la IA.',
    sa_col_institution: 'Institución',
    sa_col_country: 'País',
    sa_col_type: 'Tipo',
    sa_col_students: 'Estudiantes',
    sa_col_status: 'Estado',
    sa_col_date: 'Fecha',
    sa_col_name: 'Nombre',
    sa_col_email: 'Email',
    sa_col_role: 'Cargo',
    sa_col_approle: 'Rol',
    sa_col_lang: 'Idioma',
    sa_col_last_login: 'Último ingreso',
    sa_col_title: 'Título',
    sa_col_provider: 'Proveedor',
    sa_col_category: 'Categoría',
    sa_col_discount: 'Descuento',
    sa_col_valid_until: 'Válido hasta',
    sa_col_actions: 'Acciones',
    sa_benefits_subtitle: 'Gestiona los beneficios disponibles para los miembros de GAN.',
    sa_members_subtitle: 'Todos los usuarios registrados en GAN System.',
    sa_new_benefit: '+ Nuevo beneficio',
    sa_new_user: '+ Nuevo usuario',
    sa_loading: 'Cargando...',
  ...
  en: {
    ...
    // Superadmin
    sa_title: 'GAN Administration Panel',
    sa_subtitle: 'Manage applications, institutions and members.',
    sa_stat_total: 'Total applications',
    sa_stat_approved: 'Approved',
    sa_stat_rejected: 'Rejected',
    sa_stat_review: 'Under review',
    sa_stat_institutions: 'Active institutions',
    sa_tab_applications: 'Applications',
    sa_tab_institutions: 'Institutions',
    sa_tab_members: 'Members',
    sa_tab_benefits: 'Benefits',
    sa_filter_all: 'All',
    sa_filter_pending: 'Pending',
    sa_filter_review: 'Under review',
    sa_filter_approved: 'Approved',
    sa_filter_rejected: 'Rejected',
    sa_search_placeholder: 'Search institution or email...',
    sa_select_app: 'Select an application',
    sa_select_app_hint: 'Click any application in the list to view the details and AI evaluation.',
    sa_col_institution: 'Institution',
    sa_col_country: 'Country',
    sa_col_type: 'Type',
    ...
    sa_col_name: 'Name',
    sa_col_email: 'Email',
    sa_col_role: 'Position',
    sa_col_approle: 'Role',
    sa_col_lang: 'Language',
    sa_col_last_login: 'Last login',
    sa_col_title: 'Title',
    sa_col_provider: 'Provider',
    sa_col_category: 'Category',
    sa_col_discount: 'Discount',
    sa_col_valid_until: 'Valid until',
    sa_col_actions: 'Actions',
    sa_benefits_subtitle: 'Manage benefits available to GAN members.',
    sa_members_subtitle: 'All users registered in GAN System.',
    sa_new_benefit: '+ New benefit',
    sa_new_user: '+ New user',
    sa_loading: 'Loading...',
  ...
  pt: {
    ...
    // Superadmin
    sa_title: 'Painel de Administração GAN',
    sa_subtitle: 'Gestão de candidaturas, instituições e membros.',
    sa_stat_total: 'Total candidaturas',
    sa_stat_approved: 'Aprovadas',
    sa_stat_rejected: 'Rejeitadas',
    sa_stat_review: 'Em revisão',
    sa_stat_institutions: 'Instituições ativas',
    sa_tab_applications: 'Candidaturas',
    sa_tab_institutions: 'Instituições',
    sa_tab_members: 'Membros',
    sa_tab_benefits: 'Benefícios',
    sa_filter_all: 'Todas',
    sa_filter_pending: 'Pendentes',
    sa_filter_review: 'Em revisão',
    sa_filter_approved: 'Aprovadas',
    sa_filter_rejected: 'Rejeitadas',
    sa_search_placeholder: 'Buscar instituição ou e-mail...',
    sa_select_app: 'Selecione uma candidatura',
    sa_select_app_hint: 'Clique em qualquer candidatura da lista para ver os detalhes e a avaliação da IA.',
    sa_col_institution: 'Instituição',
    sa_col_country: 'País',
    sa_col_type: 'Tipo',
    sa_col_students: 'Estudantes',
    sa_col_status: 'Estado',
    sa_col_date: 'Data',
    sa_col_name: 'Nome',
    sa_col_email: 'E-mail',
    sa_col_role: 'Cargo',
    sa_col_approle: 'Perfil',
    sa_col_lang: 'Idioma',
    sa_col_last_login: 'Último acesso',
    sa_col_title: 'Título',
    sa_col_provider: 'Fornecedor',
    sa_col_category: 'Categoria',
    sa_col_discount: 'Desconto',
    sa_col_valid_until: 'Válido até',
    sa_col_actions: 'Ações',
    sa_benefits_subtitle: 'Gerencie os benefícios disponíveis para os membros GAN.',
    sa_members_subtitle: 'Todos os usuários registrados no GAN System.',
    sa_new_benefit: '+ Novo benefício',
    sa_new_user: '+ Novo usuário',
    sa_loading: 'Carregando...',
  ...
  fr: {
    ...
    // Superadmin
    sa_title: 'Panneau d\'Administration GAN',
    sa_subtitle: 'Gestion des candidatures, institutions et membres.',
    sa_stat_total: 'Total candidatures',
    sa_stat_approved: 'Approuvées',
    sa_stat_rejected: 'Rejetées',
    sa_stat_review: 'En examen',
    sa_stat_institutions: 'Institutions actives',
    sa_tab_applications: 'Candidatures',
    sa_tab_institutions: 'Institutions',
    sa_tab_members: 'Membres',
    sa_tab_benefits: 'Avantages',
    sa_filter_all: 'Toutes',
    sa_filter_pending: 'En attente',
    sa_filter_review: 'En examen',
    sa_filter_approved: 'Approuvées',
    sa_filter_rejected: 'Rejetées',
    sa_search_placeholder: 'Rechercher institution ou e-mail...',
    sa_select_app: 'Sélectionnez une candidature',
    sa_select_app_hint: 'Cliquez sur une candidature dans la liste pour voir les détails et l\'évaluation de l\'IA.',
    sa_col_institution: 'Institution',
    sa_col_country: 'Pays',
    sa_col_type: 'Type',
    sa_col_students: 'Étudiants',
    sa_col_status: 'Statut',
    sa_col_date: 'Date',
    sa_col_name: 'Nom',
    sa_col_email: 'E-mail',
    sa_col_role: 'Poste',
    sa_col_approle: 'Rôle',
    sa_col_lang: 'Langue',
    sa_col_last_login: 'Dernière connexion',
    sa_col_title: 'Titre',
    sa_col_provider: 'Fournisseur',
    sa_col_category: 'Catégorie',
    sa_col_discount: 'Remise',
    sa_col_valid_until: 'Valable jusqu\'au',
    sa_col_actions: 'Actions',
    sa_benefits_subtitle: 'Gérez les avantages disponibles pour les membres GAN.',
    sa_members_subtitle: 'Tous les utilisateurs enregistrés dans GAN System.',
    sa_new_benefit: '+ Nouvel avantage',
    sa_new_user: '+ Nouvel utilisateur',
    sa_loading: 'Chargement...',
